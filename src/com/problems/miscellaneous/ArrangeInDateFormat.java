...
public class ArrangeInDateFormat {
	...
	public static String findMaxDateUtil(int a, int b, int c, int d){
		...
		for(List<Integer> iterator : datePermutationsList){
			...
			}else if(iterator.get(0)==2 && iterator.get(1)==4 && iterator.get(2)==0 && iterator.get(3)==0){
				tempContainer.add(Integer.parseInt(iterator.toString().replaceAll("[\\[\\-\\+\\.\\^:,\\]\\s]","")));
			}
		...
		/*Collections.sort(tempContainer, new Comparator<List<Integer>>() {

			@Override
			public int compare(List<Integer> o1, List<Integer> o2) {
				
				return (o1.get(0)).compareTo(o2.get(0));
				//&& (o1.get(1).compareTo(o2.get(1))) && (o1.get(2).compareTo(o2.get(2))) && (o1.get(1).compareTo(o2.get(1)))
			}
		});*/
	...
	public static void main(String[] args) {
		...
		int[] input = {1,3,7,8};
		System.out.println(ArrangeInDateFormat.findMaxDateUtil(2, 4, 0, 0));
